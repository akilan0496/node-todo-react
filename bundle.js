...
ReactDOM.render(React.createElement(TodoComponent, { url: '/', pollInterval: 100000 }), document.getElementById('content'));

},{"./components/TodoComponent":165,"react":159,"react-dom":3}],164:[function(require,module,exports){
var React = require('react');
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'col-md-8' },
					React.createElement('input', { type: 'text', placeholder: 'What needs to be done...', className: 'form-control', value: this.state.task, onChange: this.handleOnChange })
				),
				React.createElement(
					'div',
					{ className: 'col-md-4' },
					React.createElement('input', { type: 'submit', value: 'Add', className: 'btn btn-default' })
				)
			)
		);
	}
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(TextBox, { onTodoSubmit: this.handleTodoSubmit }),
          React.createElement(TodoList, { onTodoDelete: this.handleTodoDltClick, onTodoClick: this.handleTodoClick, onButtonClick: this.handleButtonClick,
...
},{"../superAgent/helper":168,"./TextBox":164,"./TodoList":166,"async":2,"react":159,"superagent":160}],166:[function(require,module,exports){
var React = require('react');
...
var TodoList = React.createClass({
    ...
    render: function () {
        var todoNodes = this.props.data.map(function (todo) {
            return React.createElement(TodoNode, { onTodoClick: this.handleTodoClick, onTodoDelete: this.handleTodoDelete, task: todo.task, todoId: todo._id, active: todo.active, key: todo._id });
        }, this);
        return React.createElement(
            'div',
            { className: 'todoList' },
            ...
            React.createElement(
                ...
                React.createElement('input', { type: 'button', value: 'All Todo', onClick: this.fetchAll, className: 'btn btn-default' }),
                React.createElement('input', { type: 'button', value: 'Completed Todo', onClick: this.fetchCompleted, className: 'btn btn-default' }),
                React.createElement('input', { type: 'button', value: 'Pending Todo', onClick: this.fetchNew, className: 'btn btn-default' })
            )
        );
    }
});
...
},{"./TodoNode":167,"react":159}],167:[function(require,module,exports){
var React = require('react');

var TodoNode = React.createClass({
  displayName: "TodoNode",
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "form",
        null,
        React.createElement("div", { className: "row empty-height" }),
        React.createElement(
          "div",
          { className: "row" },
          React.createElement(
            "div",
            { className: "col-md-8" },
            React.createElement("input", { className: "task", type: "checkbox", onClick: this.handleClick, checked: !this.props.active }),
            React.createElement(
              "span",
              { className: clsName },
              this.props.task
          ...
          React.createElement(
            "div",
            { className: "col-md-2" },
            React.createElement("input", { type: "Button", onClick: this.handleDelete, className: "btn btn-default btn-sm", value: "Delete" })
          )
        )
      )
    );
...
exports.getAllTodos = function (url, _this, cb) {
  var _thisObj = _this;
  request.get(baseURL + url).end(function (err, res) {
...
exports.addOrUpdateTodo = function (url, todo, _this, cb) {
  var _thisObj = _this;
  request.post(baseURL + url).set('Content-Type', 'application/json').send(JSON.stringify(todo)).end(function (err, res) {
    if (cb) {
      cb(null, res);
    }
  }.bind(_thisObj));
...
exports.deleteTodo = function (url, _this, cb) {
  var _thisObj = _this;
  request.delete(baseURL + url).end(function (err, res) {
    if (cb) {
      cb(null, res);
    }
  }.bind(_thisObj));
